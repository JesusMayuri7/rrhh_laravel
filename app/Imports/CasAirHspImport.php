    ...
    public function collection(Collection $rows)
    {
        foreach ($rows as $row) 
        {
           AirHspCasDB::create([                               
                ...
                "fecha_inicio_vigencia_reg" =>strlen($row["fecha_inicio_vigencia_reg"])==0 ? null: Carbon::createFromFormat('d/m/Y',$row["fecha_inicio_vigencia_reg"]),
                ...
                "codigo_tipo_empleado_publico" =>$row["codigo_tipo_empleado_publico"],    
                "desc_tipo_empleado_publico" =>$row["desc_tipo_empleado_publico"],    
