...
class PersonalFormativaImport implements ToCollection,WithHeadingRow
{
      ...
      // return $rows;
        ...
        {                                
                PersonalFormativa::create([                                                              
                    ...
                    "fe_cese" =>$row["fe_cese"] ? Carbon::instance(\PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($row["fe_cese"])) : null,
                ]);                                       
        }  // foreach
    } //funcion
