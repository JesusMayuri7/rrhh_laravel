...
use App\Imports\CertificacionPresuImport;

class CertificacionPresuController extends BaseController
{
   ...
   public function import(Request $request) 
   {
       ...
       {        
          $data = Excel::import(new CertificacionPresuImport(), $file->getClientOriginalName(), 'local', \Maatwebsite\Excel\Excel::XLS);
